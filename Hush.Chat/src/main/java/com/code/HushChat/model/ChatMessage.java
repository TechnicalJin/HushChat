...
public class ChatMessage {
    ...
    private String fileName; // Original filename for file messages
    private String fileContentType; // MIME type for file messages
    private Long fileSize; // Size in bytes for file messages
